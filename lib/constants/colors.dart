...
class AppColors {
  ...
  static const Color captionText = Color(0xFF94A3B8);   // Faded text para sa subtitles
  static const Color divider = Color(0xFFE2E8F0);       // Lines at borders
  static const Color cardBorder = Color(0xFFF1F5F9);    // Subtle borders para sa cards
  ...
  static const Color urgent = Color(0xFFF59E0B);        // Priority alerts (Far participants)
  static const Color urgentLight = Color(0xFFFEF3C7);
  static const Color starGold = Color(0xFFFFB800);      // Bright Gold para sa Star Ratings
}
